...
<script>
		...
		function showAgMap(){
			if(!agsMap){
			 ...
			 var dmdz="http://192.168.15.83:6080/arcgis/rest/services/test/wgs84Dmdz/MapServer";
			 var dmdz4="http://192.168.15.83:6080/arcgis/rest/services/test/wgs84Dmdz/MapServer";
			 //var layer = esri.layers.ArcGISTiledMapServiceLayer(ydtUrl);
			//agsMap.addLayer(createTiledLayer(ydtUrl));
			//agsMap.addLayer(createDynamicLayer(jsxmUrl));
		...
		function queryTask(){
			...
			//agsMap.addLayer(createDynamicLayer(xm_qx_jy));
...
<%--			return;--%>
			...
			var dmdz="http://192.168.15.83:6080/arcgis/rest/services/test/wgs84Dmdz/MapServer/0";
			var queryTask = new esri.tasks.QueryTask(dmdz);
