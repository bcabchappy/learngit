...
public class Baidu {
    ...
    public static void main(String[] args) {
        Map<String, Double> location = convertMC2LL(7851728.184519861, 1677804.7733401442);//lng,lat 13372307.47, 3514145.00
        System.out.println(location.get("lng")+","+location.get("lat"));
        location=new HashMap<String, Double>();
        location.put("lng", 118.1094312898d);
        location.put("lat", 24.5403378984d);
        location = convertLL2MC(location.get("lng"),location.get("lat"));//x,y
        java.text.NumberFormat nf = java.text.NumberFormat.getInstance();   
		nf.setGroupingUsed(false);  
        System.out.println(nf.format(location.get("x"))+","+location.get("y"));
    }
